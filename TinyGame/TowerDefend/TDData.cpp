...
#define END_COM_MAP() }  },
	...
	ComMap gComMapInfo[] = 
	{
		...
		DEF_COM_MAP( CMID_BASE_UNIT , CMID_NONE )
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM( CID_RALLY_POINT , 'R' )
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		END_COM_MAP()
		...
		COM( CID_CHOICE_BLG , 'B' ) COM( CID_CHOICE_BLG_ADV , 'V' ) 
		COM_NULL() COM_NULL() COM_NULL()
		END_COM_MAP()

		DEF_COM_MAP( CMID_BASE_TOWER , CMID_NONE )
		COM( CID_ATTACK , 'A' ) COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		END_COM_MAP()

		DEF_COM_MAP( CMID_BARRACK , CMID_BASE_BUILDING )
		COM( AID_UT_MOUSTER_1 , 'M' ) 
		COM( AID_UT_BUILDER_1 , 'B' ) 
		COM_NULL() COM_NULL() COM_NULL()
		...
		COM( AID_BT_TOWER_CUBE     , 'C' )
		COM( AID_BT_TOWER_CIRCLE   , 'R' ) 
		COM( AID_BT_TOWER_DIAMON   , 'D' )
		COM( AID_BT_TOWER_TRIANGLE , 'T' ) 
		COM( AID_BT_BARRACK        , 'B' )
