...
#define END_COM_MAP() }  },
	...
	ComMap gComMapInfo[] = 
	{
		...
		COM( CID_ATTACK , Keyboard::eA ) 
		COM( CID_MOVE   , Keyboard::eM )
		COM( CID_HOLD   , Keyboard::eH )
		COM_NULL() COM_NULL()
		...
		DEF_COM_MAP( CMID_BASE_UNIT , CMID_NONE )
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM( CID_RALLY_POINT , Keyboard::eR )
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		END_COM_MAP()
		...
		COM( CID_CHOICE_BLG , Keyboard::eB ) COM( CID_CHOICE_BLG_ADV , Keyboard::eV )
		COM_NULL() COM_NULL() COM_NULL()
		END_COM_MAP()

		DEF_COM_MAP( CMID_BASE_TOWER , CMID_NONE )
		COM( CID_ATTACK , Keyboard::eA ) COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		COM_NULL() COM_NULL() COM_NULL() COM_NULL() COM_NULL()
		END_COM_MAP()

		DEF_COM_MAP( CMID_BARRACK , CMID_BASE_BUILDING )
		COM( AID_UT_MOUSTER_1 , Keyboard::eM )
		COM( AID_UT_BUILDER_1 , Keyboard::eB )
		COM_NULL() COM_NULL() COM_NULL()
		...
		COM( AID_BT_TOWER_CUBE     , Keyboard::eC )
		COM( AID_BT_TOWER_CIRCLE   , Keyboard::eR )
		COM( AID_BT_TOWER_DIAMON   , Keyboard::eD )
		COM( AID_BT_TOWER_TRIANGLE , Keyboard::eT )
		COM( AID_BT_BARRACK        , Keyboard::eB )
