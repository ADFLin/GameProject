	...
	case UI_GAME_SETTING_PANEL:
		{
			...
			mSettingPanel->setEventCallback( WidgetEventCallBack( this , &NetRoomSettingHelper::onWidgetEvent ) );
		}
		break;
...
void NetRoomSettingHelper::setMaxPlayerNum( int num )
{
	...
	{
		LogMsg( "( %s %s )Number of Slots are less than Max Player Number" , __FILE__ , __LINE__ );
	}
