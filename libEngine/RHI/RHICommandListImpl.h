...
namespace Render
{
	...
	public:
		...
		RHI_FUNC(void RHISetGraphicsShaderBoundState(GraphicsShaderStateDesc const& state));
		RHI_FUNC(void RHISetMeshShaderBoundState(MeshShaderStateDesc const& state));
