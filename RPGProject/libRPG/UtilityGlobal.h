...
void       UG_ConnectEvent( EventType type , int id , EvtCallBack const& callback , TRefObj* holder = nullptr );
void       UG_DisconnectEvent( EventType type , EvtCallBack const& callback , TRefObj* holder = nullptr );
