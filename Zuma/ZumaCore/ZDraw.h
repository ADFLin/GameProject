...
namespace Zuma
{
	...
	public:
		static bool init();
		static void drawAimArrow ( IRenderSystem& RDSystem , ZFrog const& frog , Vec2D const& aimPos , ZColor aimColor );
		static void drawQuakeMap ( IRenderSystem& RDSystem , ZQuakeMap& map , ITexture2D* texLvBG , Vec2D const pos[] );
